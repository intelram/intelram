...
enum class Screen {
    ...
    OTP_SECURITY, DATA_BREACH, SCAN_WEBSITE, SCAN_EMAIL, HARDWARE_DETAIL, PORTS_DETAIL, OS_DETAIL, CHAT, CHAT_CONVERSATION,
...
data class AppUiState(
    ...
    val emailVerdict: EmailVerdict? = null,
    val emailChecking: Boolean = false,
